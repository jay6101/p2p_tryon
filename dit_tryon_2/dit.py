...
class DiT(nn.Module):
    def __init__(self, img_size, dim=64, patch_size=4,
        ...
        self.cloth_agnostic_patches = nn.Sequential(
            nn.Conv2d(in_channels+1, dim, kernel_size=patch_size, 
                      stride=patch_size, padding=0, bias=False),
        )
    ...
    def forward(self, x, t, cloth_agnostic, garment):
        ...
        cloth_agnostic_tokens = cloth_agnostic_tokens + self.pos_embedding
        garment_tokens = garment_tokens + self.pos_embedding
